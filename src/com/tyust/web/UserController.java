...
public class UserController{
	...
	public String info(String loginname,ModelMap map){
		User user = userService.info(loginname);
	...
	public String quit(HttpServletRequest request){
		...
		return "redirect:/jsps/user/login";
	}
	...
	public String updateInfo(User formUser,HttpServletRequest request){
		User user = (User) request.getSession().getAttribute("sessionUser");
		if(user==null){
			request.setAttribute("msg", "您还未登录！");
			return "/jsps/user/login";
		...
		try {
			...
			userService.updateInfo(user.getUid(),email,gender,nickname);
//			System.out.println("email="+email+"性别是:"+gender+"昵称是:"+nickname);
			request.setAttribute("msg", "信息修改成功成功！");
			request.setAttribute("code", "success");
			return "/jsps/msg";
		} catch (Exception e) {
			request.setAttribute("msg", e.getMessage());
